...
class TestGeojson {
    ...
    @Test
    void validate2() throws IOException, GeoException {
        File input = new File("." + File.separator + "data" + File.separator + "1.geojson");
    ...
    @Test
    void validateInvalid() throws IOException, GeoException {
    ...
    @Test
    void validateLine() throws IOException, GeoException {
    ...
    @Test
    void validatePolygon() throws IOException, GeoException {
    ...
    @Test
    void parseShp2() throws GeoException {
        File input = new File("." + File.separator + "data" + File.separator + "大shp" + File.separator + "gis_osm_landuse_a_free_1.shp");
        File output = new File("." + File.separator + "output" + File.separator + "gis_osm_landuse_a_free_1.geojson");
        FileUtil.del(output);
    ...
    @Test
    void parseShp3() throws IOException, GeoException {
    ...
    void convertType() throws GeoException {
        File input = new File("." + File.separator + "data" + File.separator + "1.geojson");
        File output = new File("." + File.separator + "output" + File.separator + "1_convertType.geojson");
    ...
    void coordinateTransform() {
        ...
        Assertions.assertDoesNotThrow(() -> {
            ...
            File wgs84 = new File("." + File.separator + "output" + File.separator + "1_wgs84.geojson");
            File bd09 = new File("." + File.separator + "output" + File.separator + "1_bd09.geojson");
